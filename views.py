...
# Cache Directory
HUGGINGFACE_CACHE_DIR = r"S:\PROJECTS\LAst Year Project Final\# New PROJECT CACHE DIR\huggingface_cache"
TORCH_CACHE_DIR = r"S:\PROJECTS\LAst Year Project Final\# New PROJECT CACHE DIR\torch_cache"
        ...
        if input_type == "text":
            ...
            if file:
                ...
                file_path = os.path.join(
                    current_app.root_path, 'static', 'files', filename)  # Use current_app
                file.save(file_path)
